# Contributing to Awesome Coding Challenge Sites

Thanks for your interest in contributing! This is a curated list of coding challenge, CTF, and interview prep platforms. All contributions are welcome — sites to add, descriptions to improve, links to fix, or categories to suggest.

## How to Contribute

1. **Fork** this repository.
2. **Create a branch** for your changes.
3. **Edit `README.md`** following the conventions below.
4. **Submit a Pull Request** with a clear title and description explaining what you changed and why.
...
Be respectful and constructive. This is a small project with the goal of helping developers find great resources. Please keep interactions friendly and on-topic.

---

*This project is dedicated to the public domain under CC0 1.0 Universal. By contributing, you agree to dedicate your contributions to the public domain as well.*
